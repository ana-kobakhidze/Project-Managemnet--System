...
export class ColumnEffects {
    ...
    GetColumn= createEffect(() => this.actions.pipe(
    ...
    UpdateColumn = createEffect(() => this.actions.pipe(
        ...
        mergeMap((columnData: ColumnActions.UpdateStarted)=> {
            return this.columnService.updateColumn(columnData.payload, columnData.boardId).pipe(
                map(response => {
                    this.store.dispatch(new Remove(false));
    ...
    DeleteColumn = createEffect(() => this.actions.pipe(
        ...
        switchMap((columnData: ColumnActions.DeleteStarted)=> {
            return this.columnService.deleteColumn(columnData.payload,columnData.boardId).pipe(
                map(() => {
                    this.store.dispatch(new Remove(false));
